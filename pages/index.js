        ...
        <div className="h-full flex max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 sm:pt-24 pb-5 sm:pb-10">
          <div className="md:grid-cols-6 custGrid">
            ...
            <Bubble
              ...
              content={
                <div>
                  My name is Ethan Mathes, and this is my website! I built it
                  from scratch so you can check out a bunch of the cool stuff
                  I've done in college, as well as my work experience. The
                  projects and pieces displayed here are a showcase of my
                  talents, skills, and knowledge acquired through my studies. I
                  have a Bachelor's in Games, Interactive Media, and Mobile with
                  a minor in Information Technology Management. I am currently
                  working as a Software QA Tester at
                  <Link
            ...
            <Bubble
              ...
              content={
                <div>
                  ...
                  third-party software with the intent to find and report bugs
                  and other issues. Testing is done on current and previous gen
                  game consoles as well as PC and mobile devices, and reporting
                  of bugs is done in JIRA. Most notably worked on Modern Warfare
                  II (2022). Due to NDA I am unable to disclose information
            ...
            <Bubble
              ...
              content={
                <div>
                  ...
                  from May of 2020 to May of 2022. During my time at this
                  company I worked on a number of projects, including the
                  <Link
                  ...
                  ). Primarily worked with NextJS and Typescript, but also
                  worked on Windows .NET applications and used React Native with
                  Expo to build the aforementioned app.
                </div>
              }
              colSpan="md:col-span-6"
            />
